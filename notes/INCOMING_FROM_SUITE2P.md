...
`C:\Users\rasmu\Projects\Repos\suite2p\lab\notes\HANDOFF_FOR_SUPPORT.md`

Copy of that note follows. Use it to score **defringed vs denoised** means
(cell-band power up, PMT-family power not up). Do not edit `mc_runs/`.
